...
insert into genre(id, title) values (4, 'genre_title_4');
...
insert into author(id, name) values (4, 'author_name_4');
...
insert into book(id, title, author_id, genre_id) values (7, 'book_title_7', 4, 4);